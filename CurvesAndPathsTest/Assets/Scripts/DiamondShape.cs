...
public class DiamondShape : MonoBehaviour {
	...
	private float bottomlengthX = 0f; 
	private float bottomlengthY = 2f; 
	private float bottomlengthZ = 0f;  
	private float midlengthX = 1f; 
	private float midlengthY = 0f; 
	private float midlengthZ = 1f; 
	private float toplengthX = 0f; 
	private float toplengthY = 2f; 
	private float toplengthZ = 0f; 
